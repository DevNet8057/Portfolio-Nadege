...
// // Liste d'articles typée
// const articles: Article[] = [
//   // ... vos articles existants avec le bon typage
// ];

function Projet({ darkMode }: ProjetProps) {
  // États typés
  const [expandedParagraph, setExpandedParagraph] = useState<number>(2);
  const [expandedArticles, setExpandedArticles] = useState<number>(10);
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-blue-400">Lumières</span>{" "}
              <span className="text-yellow-500">d'Afrique</span>
            </h1>
                  ...
                  {paragraphs
                    ...
                    .map((paragraph, index) => (
                      <div key={index} className="mb-4">
                        ...
                        {index === expandedParagraph &&
                          expandedParagraph < paragraphs.length - 1 && (
                            <button
      ...
      >
        <div className="container mx-auto px-4">
            ...
            {[
              {
                id: "article-0",
                title:
                  "Paul Kammogne Fokam : le banquier qui a mis son génie au service de l'Afrique.",
                excerpt:
                  "un homme dont le parcours incarne la vision, la rigueur et l'amour du continent africain : Dr Paul K. Fokam  ....",
                date: "16 octobre 2025",
                url: "https://www.linkedin.com/pulse/paul-kammogne-fokam-le-banquier-qui-mis-son-g%C3%A9nie-au-service-yugain-aqjdf",
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQG-lyVoCBcJ_w/article-cover_image-shrink_600_2000/B4DZnsidnQHsAQ-/0/1760610083633?e=1763596800&v=beta&t=KEpFuU2OrXFczWAza-6A_F9ph1Yp2tRCzg3zQpc2z8I",
              },
              {
                id: "article-1",
                title:
                  "La Togolaise qui révolutionne la banque grâce à l'intelligence artificielle.",
                excerpt:
                  "Elle fait partie de cette nouvelle génération d'entrepreneures africaines qui façonnent le futur grâce à la technologie. ....",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D22AQE6Tr6GGIQxKw/feedshare-shrink_1280/B4DZnIm8dBJcAs-/0/1760007280779?e=1763596800&v=beta&t=tI-iBAmDbTVGt5gY5JH2OPA5EFlEqYHG60vWP30V3_A",
              },
              {
                id: "article-2",
                title:
                  "L'ascension d'Aminata DIALLO, Générale et leader en Guinée",
                excerpt:
                  "Fille de Fatoumata Binta Diallo, plus connue sous le nom de Binta Pilote , première femme pilote d'hélicoptère en Afrique noire . Aminata DIALLO a grandi...",
                date: "15 Juin 2025",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQEbjObeqLX4Dg/article-cover_image-shrink_600_2000/B4DZjgWBl3GkAU-/0/1756110528620?e=1763596800&v=beta&t=iuebUF7IX3Ti4ydA_3OM5ANoqMuFa3G1xBJEivOf2Lk",
              },
              {
                id: "article-3",
                title:
                  "expert reconnu en cybersécurité et cofondateur d'Africa CyberSec.",
                excerpt:
                  "Eric Ngabonziza , expert reconnu en cybersécurité et cofondateur d'Africa CyberSec....",
                date: "1 Octobre 2025",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D22AQFBaEZbcaGLmg/feedshare-shrink_800/B4DZmV7sw0H4Ag-/0/1759157088762?e=1763596800&v=beta&t=-LwQ6yLQqaqJTlEXTM_0Quly_oJOSghq6vPcwEtxtsU",
              },
              {
                id: "article-4",
                title:
                  "Babacar Charles Ndoye, expert en Gouvernance, Risque et Conformité (GRC).",
                excerpt:
                  "Avec plus de 20 ans d'expérience internationale dans les technologies de l'information et la cybersécurité...",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D22AQHxTUvfM9NgZw/feedshare-shrink_800/B4DZl25VX8JMAk-/0/1758636372538?e=1763596800&v=beta&t=wzBz1NMLLpAWracWdrUKTGosbKXZrAV6pRmIHREE2YA",
              },
              {
                id: "article-5",
                title:
                  "De la data à la blockchain : le parcours visionnaire de Nelly Chatue-Diop",
                excerpt:
                  " informaticienne camerounaise et entrepreneure à la tête de Ejara, une plateforme qui révolutionne l'investissement en Afrique grâce à la blockchain....",
                date: "15 Août  2025",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQHbH0Y98tul8g/article-cover_image-shrink_423_752/B4DZiFOOpMHYAU-/0/1754581766420?e=1763596800&v=beta&t=--dFF-057L6uT9xgrA76I1BRv7nWEC0Fi3kWsv3Q0cU",
              },
              {
                id: "article-6",
                title:
                  "Henri-Claude Oyima : bâtisseur d'une finance africaine souveraine",
                excerpt:
                  "Henri-Claude Oyima ministre d'État de l'Économie et des Finances du Gabon et PDG du groupe BGFIBank...",
                date: "23 Juillet 2025",
                url: "https://www.linkedin.com/pulse/henri-claude-oyima-ministre-d%C3%A9tat-de-l%C3%A9conomie-et-des-nadege-yugain-wxiof",
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQEH5zvrqcO2sQ/article-cover_image-shrink_720_1280/B4DZmlsAPWIcAI-/0/1759421401193?e=1763596800&v=beta&t=WcQ3_pACMiLNmO3e69Fe3TrDjBFP93gleOHwTvVshBs",
              },
              {
                id: "article-7",
                title: "Olufemi Otedola : bâtisseur et mentor des générations",
                excerpt:
                  " Olufemi Peter Otedola CON , une figure emblématique de l'entrepreneuriat nigérian et africain. Son histoire est celle d'un homme qui a bâti un empire dans l'énergie...",
                date: "2 septembre 2025",
                url: "https://www.linkedin.com/pulse/olufemi-peter-otedola-un-parcours-qui-%C3%A9lectrise-lafrique-yugain-zvnpf",
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQE01l3aQFaKRA/article-cover_image-shrink_600_2000/B4DZkJStDFGgAQ-/0/1756797523001?e=1763596800&v=beta&t=yc5z7Pz5Jpbb3bLpBButtQ1kXxlXg6_-MONIQuXtlYs",
              },
              {
                id: "article-8",
                title:
                  "Bertrand Mbouck : Un parcours de rigueur, d'excellence et d'inspiration pour la jeunesse africaine",
                excerpt:
                  " Né le 12 mai 1978 à Marseille, Bertrand Mbouck grandit à Douala dans une famille de cinq enfants. Très tôt, il fait preuve d'un esprit brillant et d'une discipline rigoureuse....",
                date: "15 Août  2025",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D12AQEvpMc8yk-NRw/article-cover_image-shrink_180_320/B4DZgtFupQGkAY-/0/1753103133797?e=1763596800&v=beta&t=-rZvP7hmAn6DhTFauXUQks2oyaPEMpIeTq9uHD1f3fU",
              },
              {
                id: "article-9",
                title: "un entrepreneur visionnaire, Godefroy Kouokam ",
                excerpt:
                  "Avec plus de 20 ans d'expérience internationale dans la gestion d'entreprises et de projets stratégiques, Godefroy Kouokam s'impose...",
                ...
                backgroundImage:
                  "https://media.licdn.com/dms/image/v2/D4D22AQH9Ar1DtpsHDw/feedshare-shrink_800/B4DZne9HwYGkAk-/0/1760382209059?e=1763596800&v=beta&t=U6_oWU0cG2HF1S4zLHkv0jvE4PZfC1e222VBsRP7N6Q",
              },
            ]
              .slice(0, expandedArticles)
              .map((article) => (
                <div
                  key={article.id}
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: (article as Article).backgroundImage
                        ? `url(${(article as Article).backgroundImage})`
                        : undefined,
                  ...
                  >
                    {!(article as Article).backgroundImage && (
                      <svg
          ...
          >
            ...
            >
              Découvrez davantage de contenu de Lumières d'Afrique sur LinkedIn
              et vous avez aussi la possibilité de voir mes reportages
              principalement sur YouTube et d'autres réseaux sociaux. N'hésitez
              pas à me contacter via WhatsApp ou par e-mail pour vos projets,
              collaborations, suggestions ou toute autre idée. Je suis à votre
              disposition pour échanger et partager !
            </p>
          </div>
          ...
          <div className="block md:hidden">
            <div className="grid grid-cols-1 gap-6">
              {[
                ...
                },
                {
                  ...
                  url: "https://www.linkedin.com/posts/nadege-yugain-b901ba352_lumiaeyresdafrique-entrepreneuriatafricain-activity-7382005581265588224-fcdO?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFfzcRwBAv8IlhvIa-IB3Xj6Kbl9YrywJD4",
                  backgroundImage:
                    "https://media.licdn.com/dms/image/v2/D4D22AQE6Tr6GGIQxKw/feedshare-shrink_800/B4DZnIm8dBJcAg-/0/1760007280600?e=1763596800&v=beta&t=4_qkuQDXmzT32MNcb72KBTYKzjsP0F9QihqVj9juR7g",
                },
                {
                  id: "article-2",
                  title:
                ...
                },
                {
                  id: "article-7",
                  title:
                    "Olufemi Otedola : bâtisseur et mentor des générations",
                  excerpt:
                    " Olufemi Peter Otedola CON , une figure emblématique de l'entrepreneuriat nigérian et africain. Son histoire est celle d'un homme qui a bâti un empire dans l'énergie...",
                  date: "2 septembre 2025",
                  url: "https://www.linkedin.com/pulse/olufemi-peter-otedola-un-parcours-qui-%C3%A9lectrise-lafrique-yugain-zvnpf",
            ...
            >
              ...
              >
                Découvrez davantage de contenu de Lumières d'Afrique sur
                LinkedIn et vous avez aussi la possibilité de voir mes
                reportages principalement sur YouTube et d'autres réseaux
                sociaux. N'hésitez pas à me contacter via WhatsApp ou par e-mail
                pour vos projets, collaborations, suggestions ou toute autre
                idée. Je suis à votre disposition pour échanger et partager !
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            >
              Votre soutien peut faire grandir Lumières d'Afrique : de simple
              newsletter, nous voulons devenir un média de référence et, à
              terme, une maison d'édition africaine engagée à révéler les
              talents du continent. Ensemble, faisons briller les voix de
              l'Afrique.
            </p>
          </div>

          <div
            className={`max-w-2xl mx-auto rounded-xl p-8 border ${
              darkMode
                ? "bg-gray-700 border-gray-600"
                : "bg-white border-gray-200"
            }`}
            ...
            <button
              onClick={() => {
                ...
                navigator.clipboard
                  ...
                  .then(() => {
                    alert(
                      "Informations de paiement copiées dans le presse-papiers !"
                    );
                  })
                  .catch(() => {
                    alert(message);
