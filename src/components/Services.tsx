...
const demoServices: Service[] = [
  {
    ...
    description: "Vérification rigoureuse des faits pour garantir l'exactitude des informations publiées."
  },
  {
    icon: "fa-microphone",
    title: "Interviews",
  ...
  },
  {
    icon: "fa-video",
    title: "Reportages",
    description: "Couverture complète d'événements avec analyse approfondie et perspectives multiples."
  },
  {
    icon: "fa-edit",
    title: "Révision éditoriale",
    description: "Amélioration de la qualité rédactionnelle et correction de vos contenus existants."
  },
  {
    icon: "fa-bullhorn",
    title: "Communication digitale",
    description: "Stratégies de contenu pour optimiser votre présence sur les réseaux sociaux."
  },
  {
    icon: "fa-search",
    title: "Enquêtes journalistiques",
    description: "Investigations approfondies sur des sujets complexes avec rigueur professionnelle."
  },
  {
    icon: "fa-camera",
    title: "Photojournalisme",
    description: "Capture d'images percutantes pour accompagner vos articles et reportages."
  },
  {
    icon: "fa-podcast",
    title: "Création de podcasts",
    description: "Production de contenu audio professionnel pour élargir votre audience."
  },
  {
    icon: "fa-globe",
    title: "Correspondance internationale",
    description: "Couverture d'événements internationaux avec une perspective locale."
  },
  {
    icon: "fa-chart-line",
    title: "Analyse de données",
    description: "Interprétation de statistiques et données pour des articles informatifs."
  },
  {
    icon: "fa-users",
  ...
  },
  {
    ...
    description: "Création de contenus originaux et engageants pour tous supports."
  }
];

const Services: React.FC<ServicesProps> = ({ darkMode = false, services = demoServices }) => {
  ...
  const duplicatedGroups = [...serviceGroups, ...serviceGroups, ...serviceGroups];
    ...
    <>
      ...
      <section
        ...
        className={`min-h-screen py-16 relative overflow-hidden ${
          darkMode ? "bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900" : "bg-gradient-to-br from-blue-50 via-white to-purple-50"
        }`}
      >
          ...
          <div className="text-center mt-8 flex justify-center gap-4">
            {canShowMore && (
              ...
              >
                ...
                Voir plus ({Math.min(3, services.length - visibleServicesCount)} de plus)
              </button>
            )}
